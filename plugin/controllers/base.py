...
TEMPLATE_ALIASES = {
    ...
    "web/removelocation": TEMPLATE_WEB_ADDLOCATION,
    "web/timerdelete": TEMPLATE_WEB_LOADEPG,
    "web/moviemove": TEMPLATE_WEB_LOADEPG,
    "web/mediaplayercmd": TEMPLATE_WEB_ADDLOCATION,
