...
function getStatusInfo(){$.ajax({url:"/api/statusinfo",dataType:"json",cache:!1,success:function(a){$("#slider").slider("value",a.volume);$("#amount").val(a.volume);!0==a.muted?(mutestatus=1,$("#volume-indicator").toggleClass("volume_mute",!0)):(mutestatus=0,$("#volume-indicator").toggleClass("volume_mute",!1));setOSD(a);var b=$("#osd_status");0==b.length&&($("body").append('<div id="osd_status"></div>'),b=$("#osd_status"));var c=$("#recording-indicator");0==c.length&&(b.append('<span id="recording-indicator" class="led-box"><div class="led led-red"></div></span>'),
