...
function getStatusInfo(){$.ajax({url:"/api/statusinfo",dataType:"json",cache:!1,success:function(a){$("#slider").slider("value",a.volume);$("#amount").val(a.volume);!0==a.muted?(mutestatus=1,$("#volume-indicator").toggleClass("volume_mute",!0)):(mutestatus=0,$("#volume-indicator").toggleClass("volume_mute",!1));setOSD(a);var b="";"true"==a.isRecording&&(b="<a href='#' onClick='load_maincontent(\"ajax/timers\"); return false;'><div title='"+tstr_rec_status+a.Recording_list+"' class='led-box'><div class='led-red'></div></div></a>");
