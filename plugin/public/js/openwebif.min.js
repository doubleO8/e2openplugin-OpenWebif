...
$("#osd_status").html(b+'<div id="standby-indicator" class="standby_image">&nbsp;</div>');b=$("#standby-indicator");b.toggleClass("in_standby",a.state.standby);b.on("click",function(a){a.preventDefault();toggleStandby()})},error:function(){$("#osd, #osd_bottom").html("")}})}
